...
public class AdminController {
    ...
    public AdminVO<ListVO<SmzdmItemVO>> list(@Validated SmzdmQueryDTO dto) {
        ...
        return AdminVO.success(new ListVO<SmzdmItemVO>().setTotal(page.getTotalElements()).setRows(resp));
    }
